...
class _PlayerProfileScreenState extends ConsumerState<PlayerProfileScreen> {
  ...
  Widget _actionButton(String label, VoidCallback onPressed, {bool primary = false}) {
    return SizedBox(
                            ...
                            children: [
                              ...
                              Center(
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    border: Border.all(
                                      color: RankBadge.colorFor(_player?['rank'] ?? 'Bronze'),
                                      width: 3,
                                    ),
                                  ),
                                  child: Center(
                                    child: Text(
                                      (_player?['username'] ?? 'P')[0].toUpperCase(),
                                      style: const TextStyle(
                                        color: Colors.white,
                                        fontSize: 32,
                                        fontWeight: FontWeight.bold,
                              ...
                              Center(
                                child: Row(
                                  ...
                                  children: [
                                    RankBadge(rank: _player?['rank'] ?? 'Bronze'),
                              ...
                              Row(
                                children: [
                                  _statBox('MATCHES', '${_stats?['matchesPlayed'] ?? 0}'),
                                  const SizedBox(width: 8),
                                  _statBox('WINS', '${_stats?['matchesWon'] ?? 0}'),
                                  const SizedBox(width: 8),
                                  _statBox('LOSSES', '${_stats?['matchesLost'] ?? 0}'),
                                ],
                              ),
                              const SizedBox(height: 8),
                              Row(
                                children: [
                                  _statBox('WIN RATE', '${_stats?['winRate'] ?? 0}%'),
                                  const SizedBox(width: 8),
                                  _statBox('DRAWS', '${_stats?['draws'] ?? 0}'),
                                  const SizedBox(width: 8),
                                  _statBox('ROUNDS', '${(_stats?['roundsWon'] ?? 0) + (_stats?['roundsLost'] ?? 0)}'),
                                ],
                              ),
                              const SizedBox(height: 24),
