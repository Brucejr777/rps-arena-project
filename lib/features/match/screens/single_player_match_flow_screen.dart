...
class _SinglePlayerMatchFlowScreenState
  ...
  /// Consistent in-game header: ROUND number on top, scoreboard below it.
  ...
  Widget build(BuildContext context) {
    return ThemeBackground(
      ...
      child: Stack(
        children: [
          _buildStageContent(),
          // END MATCH kept at bottom-right so it never collides with the
          // round header / scoreboard above.
          if (_canEndMatchNow)
            Positioned(
              bottom: 8,
              right: 16,
